import PhotographersDatas from "./Photographers.js";
const DB = {
    "photographers": [
        {
            "name": "Mimi Keel",
...
const MEDIA_DATAS = DB.media;
// const PHOTOGRAPHER_DATAS = DB.photographers;

export default class MediaDatas {

    static findMediasByPhotographer(id) {
        if (!!id) {
            let allMedias = [];
            MEDIA_DATAS.forEach(media => {
    ...
    aggregatesLikesByPhotographerId(id) {
        if (!!id) {
            let allMedias = findMediasByPhotographer(id);
